...
public class RenderGlobal implements IWorldEventListener, IResourceManagerReloadListener
{
    ...
    private boolean field_184386_ad = false;
    ...
    public void renderEntities(Entity renderViewEntity, ICamera camera, float partialTicks)
    {
        ...
        else
        {
            ...
            if (!list2.isEmpty())
            {
                ...
                {
                    this.renderManager.func_188389_a(entity3, partialTicks);
                }
            }
    ...
    public String getDebugInfoRenders()
    {
        ...
        return String.format("C: %d/%d %sD: %d, L: %d, %s", new Object[] {Integer.valueOf(j), Integer.valueOf(i), this.mc.renderChunksMany ? "(s) " : "", Integer.valueOf(this.renderDistanceChunks), Integer.valueOf(this.field_184387_ae.size()), this.renderDispatcher == null ? "null" : this.renderDispatcher.getDebugInfo()});
    }
    ...
    public void setupTerrain(Entity viewEntity, double partialTicks, ICamera camera, int frameCount, boolean playerSpectator)
    {
        ...
        if (!flag && this.displayListEntitiesDirty)
        {
            ...
            Entity.func_184227_b(MathHelper.clamp_double((double)this.mc.gameSettings.renderDistanceChunks / 8.0D, 1.0D, 2.5D));
    ...
    public void drawSelectionBox(EntityPlayer player, RayTraceResult movingObjectPositionIn, int execute, float partialTicks)
    {
        if (execute == 0 && movingObjectPositionIn.typeOfHit == RayTraceResult.Type.BLOCK)
        {
            ...
            if (iblockstate.getMaterial() != Material.air && this.theWorld.getWorldBorder().contains(blockpos))
            {
                ...
                drawSelectionBoundingBox(iblockstate.getCollisionBoundingBox(this.theWorld, blockpos).func_186662_g(0.0020000000949949026D).offset(-d0, -d1, -d2));
            }
    ...
    {
        this.field_184387_ae.add(pos.toImmutable());
    }
    ...
    public void func_184377_a(SoundEvent soundIn, BlockPos pos)
    {
        ...
        if (soundIn != null)
        {
            ItemRecord itemrecord = ItemRecord.func_185074_a(soundIn);
            ...
            PositionedSoundRecord positionedsoundrecord = PositionedSoundRecord.func_184372_a(soundIn, (float)pos.getX(), (float)pos.getY(), (float)pos.getZ());
        ...
        switch (soundID)
        {
            ...
            case 1028:
                ...
                if (entity != null)
                {
                    ...
                    if (soundID == 1023)
                    {
                        this.theWorld.func_184134_a(d4, d5, d6, SoundEvents.entity_wither_spawn, SoundCategory.HOSTILE, 1.0F, 1.0F, false);
                    }
                    else
                    {
                        this.theWorld.func_184134_a(d4, d5, d6, SoundEvents.entity_enderdragon_death, SoundCategory.HOSTILE, 5.0F, 1.0F, false);
                    }
                }
    ...
    public void playAuxSFX(EntityPlayer player, int sfxType, BlockPos blockPosIn, int data)
    {
        ...
        {
            case 1000:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.block_dispenser_dispense, SoundCategory.BLOCKS, 1.0F, 1.0F, false);
                break;

            case 1001:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.block_dispenser_fail, SoundCategory.BLOCKS, 1.0F, 1.2F, false);
                break;

            case 1002:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.block_dispenser_launch, SoundCategory.BLOCKS, 1.0F, 1.2F, false);
                break;

            case 1003:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.entity_endereye_launch, SoundCategory.NEUTRAL, 1.0F, 1.2F, false);
                break;

            case 1004:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.entity_firework_shoot, SoundCategory.NEUTRAL, 1.0F, 1.2F, false);
                break;

            case 1005:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.block_iron_door_open, SoundCategory.BLOCKS, 1.0F, this.theWorld.rand.nextFloat() * 0.1F + 0.9F, false);
                break;

            case 1006:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.block_wooden_door_open, SoundCategory.BLOCKS, 1.0F, this.theWorld.rand.nextFloat() * 0.1F + 0.9F, false);
                break;

            case 1007:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.block_wooden_trapdoor_open, SoundCategory.BLOCKS, 1.0F, this.theWorld.rand.nextFloat() * 0.1F + 0.9F, false);
                break;

            case 1008:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.block_fence_gate_open, SoundCategory.BLOCKS, 1.0F, this.theWorld.rand.nextFloat() * 0.1F + 0.9F, false);
                break;

            case 1009:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.block_fire_extinguish, SoundCategory.BLOCKS, 0.5F, 2.6F + (random.nextFloat() - random.nextFloat()) * 0.8F, false);
                break;

            case 1010:
                if (Item.getItemById(data) instanceof ItemRecord)
                {
                    this.theWorld.func_184149_a(blockPosIn, ((ItemRecord)Item.getItemById(data)).func_185075_h());
                }
                else
                {
            ...
            case 1011:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.block_iron_door_close, SoundCategory.BLOCKS, 1.0F, this.theWorld.rand.nextFloat() * 0.1F + 0.9F, false);
                break;

            case 1012:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.block_wooden_door_close, SoundCategory.BLOCKS, 1.0F, this.theWorld.rand.nextFloat() * 0.1F + 0.9F, false);
                break;

            case 1013:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.block_wooden_trapdoor_close, SoundCategory.BLOCKS, 1.0F, this.theWorld.rand.nextFloat() * 0.1F + 0.9F, false);
                break;

            case 1014:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.block_fence_gate_close, SoundCategory.BLOCKS, 1.0F, this.theWorld.rand.nextFloat() * 0.1F + 0.9F, false);
                break;

            case 1015:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.entity_ghast_warn, SoundCategory.HOSTILE, 10.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
                break;

            case 1016:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.entity_ghast_shoot, SoundCategory.HOSTILE, 10.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
                break;

            case 1017:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.entity_enderdragon_shoot, SoundCategory.HOSTILE, 10.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
                break;

            case 1018:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.entity_blaze_shoot, SoundCategory.HOSTILE, 2.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
                break;

            case 1019:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.entity_zombie_attack_door_wood, SoundCategory.HOSTILE, 2.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
                break;

            case 1020:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.entity_zombie_attack_iron_door, SoundCategory.HOSTILE, 2.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
                break;

            case 1021:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.entity_zombie_break_door_wood, SoundCategory.HOSTILE, 2.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
                break;

            case 1022:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.entity_wither_break_block, SoundCategory.HOSTILE, 2.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
                break;

            case 1024:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.entity_wither_shoot, SoundCategory.HOSTILE, 2.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
                break;

            case 1025:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.entity_bat_takeoff, SoundCategory.NEUTRAL, 0.05F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
                break;

            case 1026:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.entity_zombie_infect, SoundCategory.HOSTILE, 2.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
                break;

            case 1027:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.entity_zombie_villager_converted, SoundCategory.NEUTRAL, 2.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
                break;

            case 1029:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.block_anvil_destroy, SoundCategory.BLOCKS, 1.0F, this.theWorld.rand.nextFloat() * 0.1F + 0.9F, false);
                break;

            case 1030:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.block_anvil_use, SoundCategory.BLOCKS, 1.0F, this.theWorld.rand.nextFloat() * 0.1F + 0.9F, false);
                break;

            case 1031:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.block_anvil_land, SoundCategory.BLOCKS, 0.3F, this.theWorld.rand.nextFloat() * 0.1F + 0.9F, false);
                break;
            ...
            case 1033:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.block_chorus_flower_grow, SoundCategory.BLOCKS, 1.0F, 1.0F, false);
                break;

            case 1034:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.block_chorus_flower_death, SoundCategory.BLOCKS, 1.0F, 1.0F, false);
                break;

            case 1035:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.block_brewing_stand_brew, SoundCategory.BLOCKS, 1.0F, 1.0F, false);
                break;

            case 1036:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.block_iron_trapdoor_close, SoundCategory.BLOCKS, 1.0F, this.theWorld.rand.nextFloat() * 0.1F + 0.9F, false);
                break;

            case 1037:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.block_iron_trapdoor_open, SoundCategory.BLOCKS, 1.0F, this.theWorld.rand.nextFloat() * 0.1F + 0.9F, false);
                break;
            ...
            case 2002:
                ...
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.entity_splash_potion_break, SoundCategory.NEUTRAL, 1.0F, this.theWorld.rand.nextFloat() * 0.1F + 0.9F, false);
                break;
            ...
            case 2006:
                ...
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.entity_enderdragon_fireball_epld, SoundCategory.HOSTILE, 1.0F, this.theWorld.rand.nextFloat() * 0.1F + 0.9F, false);
                break;
            ...
            case 3000:
                ...
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.block_end_gateway_spawn, SoundCategory.BLOCKS, 10.0F, (1.0F + (this.theWorld.rand.nextFloat() - this.theWorld.rand.nextFloat()) * 0.2F) * 0.7F, false);
                break;

            case 3001:
                this.theWorld.func_184156_a(blockPosIn, SoundEvents.entity_enderdragon_growl, SoundCategory.HOSTILE, 64.0F, 0.8F + this.theWorld.rand.nextFloat() * 0.3F, false);
        }
    }
